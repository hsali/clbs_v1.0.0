...
{
	$to = 'shehbaz.bsee1395@gmail.com,shehbaz.bsee1395@outlook.com';
	...
	$message .= '<tr><td valign="top" style="background-color: #ffffff;"><b>*Name:</b></td><td>' . htmlentities($_REQUEST["custom_U995"],ENT_COMPAT,'UTF-8') . '</td></tr>';
	...
	$message .= '<tr><td valign="top" style="background-color: #ffffff;"><b>*Tell us which service you want:</b></td><td>' . htmlentities($_REQUEST["custom_U1002"],ENT_COMPAT,'UTF-8') . '</td></tr>';
	$message .= '<tr><td valign="top" style="background-color: #ffffff;"><b>*Mobile Number:</b></td><td>' . htmlentities($_REQUEST["custom_U1046"],ENT_COMPAT,'UTF-8') . '</td></tr>';
